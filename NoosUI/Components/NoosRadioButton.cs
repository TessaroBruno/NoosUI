...
{
    public class NoosRadioButton : RadioButton
    {
        [Browsable(false)]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawEllipse(SkinManager.ColorScheme.PrimaryPen,
                new Rectangle(1, Height / 2 - 7, 14, 14));
            if (Checked)
                g.FillEllipse(SkinManager.ColorScheme.ComplementaryBrush,
